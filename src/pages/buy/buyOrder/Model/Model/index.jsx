...
class Models extends React.Component {
  ...
  render() {
    console.log(this)
    const {modalVisible,okHandle,onCancel,lists}=this.props
    return (
      <div>
        <Modal
          // destroyOnClose
        ...
        >
          ...
          <Table
            ...
            pagination={{
              ...
              showTotal: () => `共${this.props.nowMsg.total}条`,
              pageSize: this.props.nowMsg.pageSize,
              total: this.props.nowMsg.total,  //数据的总的条数
              defaultCurrent: 1,
              onChange: (current) => { this.props.getData(current, ''); }, //点击当前页码
            }}
          />
        </Modal>
      </div>
